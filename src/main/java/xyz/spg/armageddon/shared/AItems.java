...
{
	@ObjectHolder(ANames.ROTTEN_PORKCHOP) public static final Item ROTTEN_PORKCHOP = null;
	@ObjectHolder(ANames.ROTTEN_BEEF) public static final Item ROTTEN_BEEF = null;
	@ObjectHolder(ANames.ROTTEN_MUTTON) public static final Item ROTTEN_MUTTON = null;
	@ObjectHolder(ANames.ROTTEN_CHICKEN) public static final Item ROTTEN_CHICKEN = null;
	@ObjectHolder(ANames.ROTTEN_EGG) public static final Item ROTTEN_EGG = null;
	@ObjectHolder(ANames.ROTTEN_RABBIT) public static final Item ROTTEN_RABBIT = null;
	...
	@ObjectHolder(ANames.COW_ZOMBIE_SPAWN_EGG) public static final SpawnEggItem COW_ZOMBIE_SPAWN_EGG = null;
	@ObjectHolder(ANames.PIG_ZOMBIE_SPAWN_EGG) public static final SpawnEggItem PIG_ZOMBIE_SPAWN_EGG = null;

	// @ObjectHolder(ANames.BLAZE_ZOMBIE_SPAWN_EGG) public static final SpawnEggItem BLAZE_ZOMBIE_SPAWN_EGG = null;
	// @ObjectHolder(ANames.EXPLOSIVE_ZOMBIE_SPAWN_EGG) public static final SpawnEggItem EXPLOSIVE_ZOMBIE_SPAWN_EGG = null;
	// @ObjectHolder(ANames.TELEPORTING_ZOMBIE_SPAWN_EGG) public static final SpawnEggItem TELEPORTING_ZOMBIE_SPAWN_EGG = null;
