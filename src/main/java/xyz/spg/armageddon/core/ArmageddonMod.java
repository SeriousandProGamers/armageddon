...
public final class ArmageddonMod
{
	...
	private void onCreateEntityAttribute(EntityAttributeCreationEvent event)
	{
		...
		event.put(AEntityTypes.RABBIT_ZOMBIE, RabbitZombie.createAttributes().build());
		event.put(AEntityTypes.WOLF_ZOMBIE, WolfZombie.createAttributes().build());
	}
	...
	private void fixSpawnEggs()
	{
		...
		by_id.put(AEntityTypes.RABBIT_ZOMBIE, AItems.RABBIT_ZOMBIE_SPAWN_EGG);
		by_id.put(AEntityTypes.WOLF_ZOMBIE, AItems.WOLF_ZOMBIE_SPAWN_EGG);
	}
	...
	private void setupEntities()
	{
		...
		SpawnPlacements.register(AEntityTypes.RABBIT_ZOMBIE, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, RabbitZombie::canRabbitZombieSpawn);
		SpawnPlacements.register(AEntityTypes.WOLF_ZOMBIE, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, WolfZombie::canWolfZombieSpawn);
	}
	...
	static
	{
		...
		entityAndSpawnEgg(ANames.WOLF_ZOMBIE, WolfZombie::new, MobCategory.MONSTER, 44975, 13545366, Functions.identity(), builder -> builder.sized(.6F, .85F).clientTrackingRange(10));
