...
@OnlyIn(Dist.CLIENT)
public final class FoxZombieModel extends AgeableModel<FoxZombieEntity>
{
	...
	@Override
	public void setLivingAnimations(FoxZombieEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick)
	{
	...
	{
		return ImmutableList.of(body, legBackRight, legBackLeft, legFrontRight, legFrontLeft);
	}

	@Override
	public void setRotationAngles(FoxZombieEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
