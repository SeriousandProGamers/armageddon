...
@OnlyIn(Dist.CLIENT)
public final class PolarBearZombieModel extends QuadrupedModel<PolarBearZombieEntity>
{
	public PolarBearZombieModel() {
	 ...
	 */
	public void setRotationAngles(PolarBearZombieEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
