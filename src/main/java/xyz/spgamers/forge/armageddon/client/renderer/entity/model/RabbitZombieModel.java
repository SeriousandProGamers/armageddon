...
@OnlyIn(Dist.CLIENT)
public final class RabbitZombieModel extends EntityModel<RabbitZombieEntity>
{
	 ...
	 */
	public void setRotationAngles(RabbitZombieEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	public void setLivingAnimations(RabbitZombieEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
