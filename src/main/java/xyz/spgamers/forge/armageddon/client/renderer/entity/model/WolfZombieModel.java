...
@OnlyIn(Dist.CLIENT)
public final class WolfZombieModel extends TintedAgeableModel<WolfZombieEntity>
{
	...
	public void setLivingAnimations(WolfZombieEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
		// func_233678_J__() -> isAngry()
