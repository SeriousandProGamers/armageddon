...
@OnlyIn(Dist.CLIENT)
public final class PandaZombieModel extends QuadrupedModel<PandaZombieEntity>
{
	private float field_217164_l;
	private float field_217165_m;
	private float field_217166_n;

	public PandaZombieModel(int p_i225948_1_, float p_i225948_2_)
	{
		super(p_i225948_1_, p_i225948_2_, true, 23F, 4.8F, 2.7F, 3F, 49);
	...
	@Override
	public void setLivingAnimations(PandaZombieEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick)
	{
	...
	@Override
	public void setRotationAngles(PandaZombieEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
	{
